...
public class QualityPageSteps extends Commonactions{
  ...
  //  ca.eleToBeClickable();
    ...
    ca.eleToBeClickable();
		...
		ca.click(qp.getChemicalTestAprv());
			...
			ca.eleToBeClickable();
			ca.click(driver.findElement(By.xpath("(//div[text()='Chemical Test']/parent::td//following-sibling::td/div/span[text()='check_circle'])[1]")));
		}
		Thread.sleep(3000);
		try{
		...
		ca.eleToBeClickable();
		ca.click(driver.findElement(By.xpath("(//div[text()='Ironing Test']/parent::td//following-sibling::td/div/span[text()='check_circle'])[1]")));
	}
		ca.eleToBeClickable();
		try{
			for(int i = 1; i <=150; i++ ){
  ...
  //  ca.eleToBeClickable();
    ...
    ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(lct.getQualitypge());
		ca.click(lct.getQualitypge());
