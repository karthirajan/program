...
public class StyleandThemePageSteps extends Commonactions{
	...
	public void user_creates_shape_and_update_shape_master(String string, String string2, String string3) throws Throwable {
		...
		ca.eleToBeClickable();
		ca.click(lct.getAndRole());
		ca.eleToBeClickable();
		ca.click(lct.getShapee());
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
	...
	public void user_is_performing_select_create_arrange_and_delete_section_activities_under_sections() throws Throwable {
		...
		//Commonactions.isElementPresent(sat.getCreateNewfMat());
		//ca.click(sat.getCreateNewfMat());
		Commonactions.isElementPresent(lct.getNFmaterial());
		ca.click(lct.getNFmaterial());
		...
		Commonactions.isElementPresent(lct.getNFmaterial1());
		ca.click(lct.getNFmaterial1());
		Commonactions.isElementPresent(sat.getCopy_ChkBx2());
		ca.click(sat.getCopy_ChkBx2());
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
		...
		WebElement from = driver.findElement(By.xpath("(//td[@data-csi-heading='Node Name::0' and contains(text(),'Section') or contains(text(),'fabric')])/span"));
		WebElement to = driver.findElement(By.xpath("(//td[@data-csi-heading='Node Name::0' and contains(text(),'Adhoc')])/span")); 
	...
	public void user_creates_and_update_style_BOM_placements(String string, String string2) throws Throwable {
		...
		try{
			List<WebElement> num = driver.findElements(By.xpath("//span[@class='attrPrimary']//parent::td/parent::tr/following-sibling::tr//td[contains(@class,'Button')]"));
			int s = num.size();
			driver.findElement(By.xpath("(//span[@class='attrPrimary']//parent::td/parent::tr/following-sibling::tr//td[contains(@class,'Button')])["+(s-1)+"]")).click();
		}
		catch(Exception we)
		{
		...
		try
		{
			WebElement bomsubtype = driver.findElement(By.xpath("((//div[contains(@data-csi-automation,'BOMSubtype')]/div)[3]//input)[1]"));
			ca.insertText(bomsubtype, "BOM");
			ca.eleToBeClickable();
			ca.jsMouseOver();
			ca.eleToBeClickable();
			ca.click(mp.getSave_btn2());
	...
	public void user_performing_delete_style_BOM_placements_and_validate_style() throws Throwable {
		...
		ca.insertText(e, "A"); 
		ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getDivITem());
		ca.click(lct.getDivITem());
		ca.eleToBeClickable();
		e.sendKeys(Keys.TAB);
		//parallel
		try{
			ca.eleToBeClickable();
			driver.findElement(By.xpath("(//div[contains(@data-csi-automation,'BOMSubtype')]//div[3]/input)[1]")).sendKeys("BOM - All False");
			ca.eleToBeClickable();
		}catch (Exception ee) {
			// TODO: handle exception
		}
	...
	public void user_performing_unlink_and_synch_from_theme_validation() throws Throwable {
		...
		try{
			ca.click(driver.findElement(By.xpath("(//span[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-Actions']/span)")));
		}catch (Exception e) {
		...
		try{
			...
			ca.click(driver.findElement(By.xpath("(//tr[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-SynchBOMFromTheme']/td[text()='Synch BOM From Theme'])[1]")));
		}
	...
	{
		List<WebElement> num = driver.findElements(By.xpath("//tr[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-UnlinkFromTheme']/td[text()='Unlink From Theme']"));
		for(int i=1;i<=num.size();i++)
		{
			WebElement unlink = driver.findElement(By.xpath("(//tr[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-UnlinkFromTheme']/td[text()='Unlink From Theme'])["+i+"]"));
			boolean displayed = unlink.isDisplayed();
			if(displayed==true)
			{
				unlink.click();
				ca.eleToBeClickable();
