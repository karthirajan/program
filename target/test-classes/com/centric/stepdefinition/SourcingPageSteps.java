...
public class SourcingPageSteps extends Commonactions{
	...
	public void user_creates_sales_region(String string, String string2) throws Throwable {
		...
		ca.eleToBeClickable();
		ca.click(lct.getRoleItm1());
		ca.eleToBeClickable();
		ca.click(lct.getSecSaleRegion());
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
	...
	public void user_validates_factory_reviews(String string) throws Throwable {
		...
		ca.eleToBeClickable();
		ca.jsScrollPageDown(lct.getResponse1());
		ca.eleToBeClickable();
		ca.click(lct.getResponse1());
		ca.eleToBeClickable();
		WebElement e = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(e, "Yes");
		...
		ca.jsMouseOver();
		ca.eleToBeClickable();
		ca.jsScrollPageDown(lct.getResponse2());
		ca.eleToBeClickable();
		ca.click(lct.getResponse2());
		ca.eleToBeClickable();
		WebElement e1 = ca.activeElement();
		ca.eleToBeClickable();
		...
		ca.jsMouseOver();
		ca.eleToBeClickable();
		ca.jsScrollPageDown(lct.getResponse3());
		ca.eleToBeClickable();
		ca.click(lct.getResponse3());
		ca.eleToBeClickable();
		WebElement e2 = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(e2, "No");
	...
	public void user_creates_Shipment(String string, String string2, String string3) throws Throwable {
		...
		ca.click(sp.getConfiDate1());
        	...
        	Commonactions.isElementPresent(sp.getConfiDate());
    		ca.click(sp.getConfiDate());
		}
