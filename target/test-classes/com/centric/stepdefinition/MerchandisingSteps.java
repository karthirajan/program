...
public class MerchandisingSteps extends Commonactions {
	...
	CalendarPage cp1=new CalendarPage();
	...
	public void navigate_to_Collection_type_and_create_data(String string)throws Throwable  {
		...
		Commonactions.isElementPresent(lct.getColorAndSize());
		ca.click(lct.getColorAndSize());
		Commonactions.isElementPresent(mp.getChildern_option_dropdown());
		mp.getChildern_option_dropdown().click();
		Commonactions.isElementPresent(lct.getLabelOption());
		ca.click(lct.getLabelOption());
		Commonactions.isElementPresent(mp.getCollection_type());
		mp.getCollection_type().click();
		Commonactions.isElementPresent(mp.getChildern_product_dropdown());
		mp.getChildern_product_dropdown().click();
		Commonactions.isElementPresent(lct.getLabelProduct());
		ca.click(lct.getLabelProduct());		
	}
	...
	public void create_plan_type_data(String string)throws Throwable {
		...
		ca.click(lct.getLabelMonthly());
		ca.click(lct.getLabelSegment());
	}
	...
	public void enumeration_creation()throws Throwable  {
		...
		Commonactions.isElementPresent(mp.getEnumeration_value_input());
		ca.click(mp.getEnumeration_value_input());
		ca.insertText(mp.getEnumeration_value_input(),"Brand X");
		ca.click(lct.getSaveAndNew());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getEnumeration_value_input());
		ca.click(mp.getEnumeration_value_input());
		ca.insertText(mp.getEnumeration_value_input(),"Brand Y");
		ca.click(lct.getSave());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getNew_action_enumeration());
		ca.click(mp.getNew_action_enumeration());
	...
	public void navigate_to_style_create_atrributes()throws Throwable {
		...
		Thread.sleep(1000);		
		Commonactions.isElementPresent(lct.getAttrTab());
		ca.click(lct.getAttrTab());
		ca.eleToBeClickable();
		ca.click(mp.getStyle_attributename_dropdown());
		ca.eleToBeClickable();		
	...
	public void navigate_to_Home_Page_and_setup_template_for_hierarchy(String string)throws Throwable {
		...
		ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getSummer2021());
		ca.click(lct.getSummer2021());
		ca.eleToBeClickable();
	...
	public void create_new_season_choose_existing_hierarchy_value(String string)throws Throwable {
		...
		ca.click(pp.getSave_Btn());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getSummer2022());
		ca.click(lct.getSummer2022());
		Commonactions.isElementPresent(mp.getBrandactiondropbtn());
		mp.getBrandactiondropbtn().click();
		Commonactions.isElementPresent(lct.getNewBrnd());
		ca.click(lct.getNewBrnd());
		ca.eleToBeClickable();		
	...
	public void under_secondarysetup_created_monthly_and_segment_setup(String mon, String seg) throws Throwable {
		...
		Commonactions.isElementPresent(mp.getAutocreatechkbox());
		ca.click(mp.getAutocreatechkbox());
		Commonactions.isElementPresent(mp.getPropagatelvlmon1());
		ca.click(mp.getPropagatelvlmon1());
		ca.click(mp.getOptver());
		ca.click(mp.getProdver());
		Commonactions.isElementPresent(mp.getNewsecsetupplanbtn());
		...
		Commonactions.isElementPresent(mp.getAutocreatechkbox());
		ca.click(mp.getAutocreatechkbox());
		Commonactions.isElementPresent(mp.getPropagatelvlmon2());
		ca.click(mp.getPropagatelvlmon2());
		ca.click(mp.getOptver());
		ca.click(mp.getProdver());
		ca.eleToBeClickable();
...
//		Commonactions.isElementPresent(mp.getPlanview());
//		ca.click(mp.getPlanview());
		...
		Commonactions.isElementPresent(mp.getAmericaview());
		ca.click(mp.getAmericaview());
		Commonactions.isElementPresent(mp.getManageview());
		ca.click(mp.getManageview());			
		ca.eleToBeClickable();		
		ca.click(mp.getCopyview());	
		Commonactions.isElementPresent(mp.getAttributedropdown());
		ca.click(mp.getAttributedropdown());
		WebElement b3 = ca.activeElement();
		ca.eleToBeClickable();
		b3.sendKeys("Folder");
		...
		ca.eleToBeClickable();		
		Commonactions.isElementPresent(mp.getBrandoption());
		ca.click(mp.getBrandoption());
...
//		{System.out.println("Summer 2021 already selected");		}
	...
	public void user_navigate_to_merch_collection_create_product(String string, String string2, String string3)throws Throwable {
		...
		ca.click(mp.getAmericabranddrp());
		WebElement b1 = ca.activeElement();
		ca.eleToBeClickable();
		b1.sendKeys("Brand X");
		ca.eleToBeClickable();		
		WebElement t1 = ca.activeElement();
		ca.eleToBeClickable();
		t1.sendKeys(Keys.TAB);
		ca.eleToBeClickable();
		
		Commonactions.isElementPresent(mp.getVersions());
		ca.click(mp.getVersions());		
		Commonactions.isElementPresent(mp.getVersionview());
		ca.click(mp.getVersionview());
		Commonactions.isElementPresent(mp.getManageview2());
		ca.click(mp.getManageview2());			
		ca.eleToBeClickable();		
		ca.click(mp.getCopyview());	
		Commonactions.isElementPresent(mp.getAttributedropdown());
		ca.click(mp.getAttributedropdown());
		...
		b2.sendKeys(Keys.TAB);
		ca.eleToBeClickable();		
		Commonactions.isElementPresent(mp.getApparelseasonopt());
		ca.click(mp.getApparelseasonopt());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(mp.getStyletype());
		ca.click(mp.getStyletype());
		ca.insertText(mp.getStyletype(), "Apparel - Color and Size");
		ca.eleToBeClickable();
		ca.click(mp.getSeasondrp());
	...
	@Then("create product for summer{int} with new from style {string}")
	public void create_product_for_summer_with_new_from_style(Integer int1, String string)throws Throwable {
//		Commonactions.isElementPresent(hp.getUser_homeBtn());
//		ca.click(hp.getUser_homeBtn());
//		ca.click(mp.getMerchandise_tab());
//		ca.eleToBeClickable();
...
//		try
//		{
//			ca.click(mp.getSummerchange2022());
//			}
//		catch(Exception e){}
//		ca.eleToBeClickable();
//		WebElement a1 = ca.activeElement();
...
//		Commonactions.isElementPresent(mp.getProductab());
//		ca.click(mp.getProductab());	
//		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getProductviews());
		ca.click(mp.getProductviews());
		...
		ca.eleToBeClickable();		
		ca.click(mp.getCopyview());		
		Commonactions.isElementPresent(mp.getIdpricpt());
		ca.click(mp.getIdpricpt());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		Commonactions.isElementPresent(mp.getSecondaryview());
		ca.click(mp.getSecondaryview());
		Commonactions.isElementPresent(mp.getSecondaryattrb());
		ca.click(mp.getSecondaryattrb());
		ca.click(mp.getAdd());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(mp.getRntpricept());
		ca.click(mp.getRntpricept());	
		ca.eleToBeClickable();
		WebElement b1 = ca.activeElement();
		ca.eleToBeClickable();
		b1.sendKeys("High");
...
//		ca.eleToBeClickable();
		...
		WebElement t3 = ca.activeElement();
		ca.eleToBeClickable();
		t3.sendKeys(Keys.TAB);
//		ca.eleToBeClickable();
		
		ca.click(mp.getTop3pricept());
		WebElement b4 = ca.activeElement();
		ca.eleToBeClickable();
		b4.sendKeys("Medium");
		ca.eleToBeClickable();		
		WebElement t4 = ca.activeElement();
		ca.eleToBeClickable();
		t4.sendKeys(Keys.TAB);
//		ca.eleToBeClickable();
		
		ca.click(mp.getTop1pricept());
		WebElement b5 = ca.activeElement();
		ca.eleToBeClickable();
		b5.sendKeys("Medium");
		ca.eleToBeClickable();		
		WebElement t5 = ca.activeElement();
		ca.eleToBeClickable();
		t5.sendKeys(Keys.TAB);
//		ca.eleToBeClickable();
		
		
		ca.click(mp.getRnt1pricept());
		WebElement b6 = ca.activeElement();
		ca.eleToBeClickable();
		b6.sendKeys("Medium");
		ca.eleToBeClickable();		
		WebElement t6 = ca.activeElement();
		ca.eleToBeClickable();
		t6.sendKeys(Keys.TAB);
//		ca.eleToBeClickable();
		
		System.out.println("Completed creating custom view with Idpricepoint");
				
		Commonactions.isElementPresent(mp.getVersions());
		ca.click(mp.getVersions());		
		Commonactions.isElementPresent(mp.getCollecversionact());
		ca.click(mp.getCollecversionact());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getSumm22chkbox());
		ca.click(mp.getSumm22chkbox());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();		
		Commonactions.isElementPresent(mp.getSum2022());
		ca.eleToBeClickable();
		ca.click(mp.getSummerchange2021());
		ca.eleToBeClickable();
		WebElement a1 = ca.activeElement();
		...
		ca.eleToBeClickable();
		ca.click(mp.getPlantab());	
		Commonactions.isElementNotPresent(mp.getApparelbo());
		Commonactions.isElementPresent(mp.getNewproduarrowbtn());
		ca.click(mp.getNewproduarrowbtn());
		Commonactions.isElementPresent(mp.getNewfromstyle());
		ca.click(mp.getNewfromstyle());
		ca.eleToBeClickable();		
		Commonactions.isElementPresent(mp.getRntchkbox());
		ca.click(mp.getRntchkbox());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();		
		Commonactions.isElementPresent(mp.getApparelbo());
		System.out.println("Completed creating new from style");
	}
	public void slider()
    {
        List<WebElement> num = driver.findElements(By.xpath(" //div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div"));
        for(int i=1;i<=num.size();i++)
        {
            WebElement slider = driver.findElement(By.xpath("( //div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div)["+i+"]"));
            boolean displayed = slider.isDisplayed();
            if(displayed==true)
            {
                ca.click(slider);
                break;
	...
	@Then("create product for summer with new from product and carryover")
	public void create_product_for_summer_with_new_from_product_and_carryover()throws Throwable {
//		Commonactions.isElementPresent(hp.getUser_homeBtn());
//		ca.click(hp.getUser_homeBtn());
//		ca.click(mp.getMerchandise_tab());
//		ca.eleToBeClickable();
...
//		ca.eleToBeClickable();
		...
		WebElement a3 = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(a3, "Tops2");
		ca.eleToBeClickable();
		ca.click(mp.getSeconlabel());
		ca.click(mp.getTops2());
//		ca.click(mp.getTopsname());
		ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(mp.getNewproduarrowbtn());
		ca.click(mp.getNewproduarrowbtn());	
		Commonactions.isElementPresent(mp.getNewfromprod());
		ca.click(mp.getNewfromprod());		
		Commonactions.isElementPresent(mp.getViewbtn());
		ca.click(mp.getViewbtn());
		Commonactions.isElementPresent(mp.getManageview2());
		ca.click(mp.getManageview2());
		ca.eleToBeClickable();		
		ca.click(mp.getCopyview());
		Commonactions.isElementPresent(mp.getOptions());
		ca.click(mp.getOptions());
		Commonactions.isElementPresent(mp.getOptversion());
		ca.click(mp.getOptversion());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		Commonactions.isElementPresent(mp.getColorway());
		ca.click(mp.getColorway());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getTops1chkbox());
		ca.click(mp.getTops1chkbox());
		ca.click(qp.getNext());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getProductinpt());
		ca.click(mp.getProductinpt());	
		WebElement a5 = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(a5, "Tops1-Copy");
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getQtyinput());
		ca.click(mp.getQtyinput());	
		WebElement a7 = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(a7, "1");
		ca.eleToBeClickable();
		
		Commonactions.isElementPresent(mp.getStylechkbox());
		ca.click(mp.getStylechkbox());	
		Commonactions.isElementPresent(mp.getStylecandichkbox());
		ca.click(mp.getStylecandichkbox());
		Commonactions.isElementPresent(qp.getFinish());
		ca.click(qp.getFinish());
		ca.eleToBeClickable();
		
		
		Commonactions.isElementPresent(mp.getTops2change());
		ca.click(mp.getTops2change());	
		WebElement a9 = ca.activeElement();
		ca.eleToBeClickable();
		ca.insertText(a9, "Tops" +Keys.ENTER);
		ca.eleToBeClickable();
		System.out.println("tops selected");	
		Commonactions.isElementPresent(mp.getNewproduarrowbtn());
		ca.click(mp.getNewproduarrowbtn());		
		Commonactions.isElementPresent(mp.getCarryover());
		ca.click(mp.getCarryover());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getTops1chkbox());
		ca.click(mp.getTops1chkbox());
		ca.click(mp1.getSave_btn1());
		Commonactions.isElementPresent(mp.getTop1carryover());
		System.out.println("Completed creating new from product and carryover");
		
		Commonactions.isElementPresent(mp.getNewproduarrowbtn());
		ca.click(mp.getNewproduarrowbtn());			
		Commonactions.isElementPresent(mp.getReplenish());
		ca.click(mp.getReplenish());		
		Commonactions.isElementPresent(mp.getTop3chkbox());
		ca.click(mp.getTop3chkbox());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getTop3replenish());
		...
		String text = Commonactions.getText(mp.getTop1idpricevalue());
		String text1 = Commonactions.getText(mp.getTop3idpricevalue());
		if(text.equalsIgnoreCase(text1))
		{
			System.out.println("tops-1 price point is equal to top-3 "+text1 +" " +text);
			Commonactions.isElementPresent(mp.getTops3Name());
			ca.click(mp.getTops3Name());
			ca.eleToBeClickable();
			Commonactions.isElementNotPresent(mp.getNewoption());
		}
		else {
			System.out.println("tops-1 price point is not equal to top-3 " +text1 +" " +text);
		}
					
	}
	@Then("Pushing the style attribute price point and gender")
	public void pushing_the_style_attribute_price_point_and_gender()throws Throwable  {
		String apparelppval = Commonactions.getText(mp.getRntppvalue());
		...
		Commonactions.isElementPresent(mp.getRounecklink());
		ca.click(mp.getRounecklink());
		ca.eleToBeClickable();
		...
		WebElement b1 = ca.activeElement();
		ca.eleToBeClickable();
		b1.sendKeys("Style Attributes");
		WebElement b2 = ca.activeElement();
		ca.eleToBeClickable();
		b2.sendKeys(Keys.TAB);
		ca.eleToBeClickable();
		
		Commonactions.isElementPresent(mp.getGenderattr());
		ca.click(mp.getGenderattr());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		Commonactions.isElementPresent(mp.getPricepointattr());
		ca.click(mp.getPricepointattr());
		Commonactions.isElementPresent(mp.getAdd());
		ca.click(mp.getAdd());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(mp.getAction());
		ca.click(mp.getAction());
		Commonactions.isElementPresent(mp.getAttribute());
		ca.click(mp.getAttribute());
		ca.eleToBeClickable();
		ca.click(qp.getNext());
		Commonactions.isElementPresent(mp.getRouneckchek());
		ca.click(mp.getRouneckchek());
		Commonactions.isElementPresent(qp.getFinish());
		ca.click(qp.getFinish());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getStyleUpdte());
		Commonactions.isElementPresent(mp.getRounecklink());
		ca.click(mp.getRounecklink());
		ca.eleToBeClickable();
		ca.click(hp.getStyleBtn());
		Commonactions.isElementPresent(lct.getPropRefresh());
		ca.click(lct.getPropRefresh());
		ca.eleToBeClickable();
		
		String gender = Commonactions.getText(mp.getGendervalue());
		String pricepoint = Commonactions.getText(mp.getPricpointvalue());
		
		if((gender.equalsIgnoreCase("Boys"))&&(pricepoint.equalsIgnoreCase("High"))){
			System.out.println("gender has a value of boys and print point in rnt is same as product value ");
		}
		else {
			System.out.println("gender has a value of boys and print point in apparel is not same as product value ");
		}
		
	}
	@Then("create product for summer with carryover style")
	public void create_product_for_summer_with_carryover_style()throws Throwable  {
		Commonactions.isElementPresent(hp.getUser_homeBtn());
		ca.click(hp.getUser_homeBtn());
		ca.eleToBeClickable();
		ca.click(mp.getMerchandise_tab());
		...
		try
		{
			Commonactions.isElementPresent(mp.getSummerchange2021());
		ca.eleToBeClickable();
		ca.clickjs(mp.getSummerchange2021());
		try
		{
			ca.click(mp.getSummerchange2021());
			}
		...
		Commonactions.isElementPresent(mp.getNewproduarrowbtn());
		ca.click(mp.getNewproduarrowbtn());	
		Commonactions.isElementPresent(mp.getCarryoverstyle());
		ca.click(mp.getCarryoverstyle());		
		Commonactions.isElementPresent(mp.getRouneckchek());
		ca.click(mp.getRouneckchek());
		ca.click(mp1.getSave_btn1());
		ca.eleToBeClickable();			
		Commonactions.isElementPresent(mp.getRounecklink());
		System.out.println("created carryover with style data ");
	}
	}
