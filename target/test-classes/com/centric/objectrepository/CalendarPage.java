...
public class CalendarPage  extends Commonactions{
	...
	@FindBy(xpath="(//td[text()='100% Cotton/Rayon Jersey'])[1]")
	...
	private WebElement calendarmsg;
	...
	@FindBy(xpath="//a[text()='Calendar_Season']//following::span[text()='more_horiz']")
	private WebElement threedotseasoncalmsg;
	...
	@FindBy(xpath="(//td[contains(text(),'100% Cotton Jersey')]//preceding::td//div[@data-csi-act='ViewSelect'])")
	...
	@FindBy(xpath="//a[contains(text(),'100% Cotton Jersey')]")
	...
	@FindBy(xpath="(//a[contains(text(),'Manual')]/following::td[@data-csi-heading='CompletionDate::0'])[1]")
	...
	@FindBy(xpath="(//td[contains(text(),'Manual')]/following::td[@data-csi-heading='Node Name:Child:Proto/Child:ActivityLevel:0' and text()='Material'])[1]")
	private WebElement ManualMatMSGActivity;
	
	@FindBy(xpath="(//td[contains(text(),'Manual')]/following::td[@data-csi-heading='Node Name:Child:Proto/Child:ActivityLevel:0' and text()='Colored Material'])[1]")
	private WebElement ManualColoredMatMSGActivity;
	...
	@FindBy(xpath="//span[@data-csi-tab-name='PO Products']")
	private WebElement POProductsTab;
	
	
	public WebElement getthreedotseasoncalmsg() {
		return threedotseasoncalmsg;
	}
	...
	public WebElement getcalendarmsg() {
		return calendarmsg;
	}
	
	public WebElement getPOProductsTab() {
		return POProductsTab;
	}
	...
	@FindBy(xpath="//span[@data-csi-tab-name='PO']")
	private WebElement potab;
	
	public WebElement getpotab() {
		return potab;
	}
	public WebElement getMastercalporefresh() {
		return mastercalporefresh;
	}
	
	public WebElement getManualMatMSGActivity() {
		return ManualMatMSGActivity;
	}
	
	public WebElement getManualColoredMatMSGActivity() {
		return ManualColoredMatMSGActivity;
	}
