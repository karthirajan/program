...
public class SourcingPage  extends Commonactions{
	...
	@FindBy(xpath="(//table[contains(@data-csi-automation,'placeholder-PurchasedOrder')]//tr/td[contains(text(),'Colorways')])[1]")
	...
	@FindBy(xpath="((//span[contains(@data-csi-automation,'filter-SupplierRequest-StyleQuotes-Node Name:Child:__Parent__/Child:Supplier')]/span)[1]/span/span[3]/preceding-sibling::span)[2]")
