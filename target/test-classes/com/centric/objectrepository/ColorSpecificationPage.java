...
////////////////
@FindBy(xpath="//span[text()='Colorway']//parent::label//parent::div/div/input[@value='Colorway']")
private WebElement colorwaychkbox;

@FindBy(xpath="//td/a[text()='Colorway']")
private WebElement colorwayvalue;	

@FindBy(xpath="//span[@data-csi-tab-name='Attribute Groups' or text()='Attribute Groups']")
private WebElement attributegrptab;	      

@FindBy(xpath="//table[contains(@data-csi-automation,'BusinessObject-AttributeGroups')]//div[text()='New Attribute Group']")
private WebElement newattributegrp;	    

@FindBy(xpath="//td[a[text()='AUT_AWGP02']]/following-sibling::td[@data-csi-heading='Attributes::0']")
private WebElement attributesdrp;	

public WebElement getAttributesdrp() {
return attributesdrp;
}

public WebElement getNewattributegrp() {
	return newattributegrp;
}


public WebElement getAttributegrptab() {
return attributegrptab;
}
...
public WebElement getColorwaychkbox() {
return colorwaychkbox;
}
}
