...
public class MerchandisePage extends Commonactions{
	...
	@FindBy(xpath="(//span[@data-csi-tab-name='Plan' or text()='Plan'])[2]")
	private WebElement plantab2;
	...
	////////////////
	@FindBy(xpath="//table[@data-csi-automation='plugin-MerchCollection-Versions-ToolbarNewActions']//div//div[2]")
	private WebElement collecversionact;
	
	@FindBy(xpath="//td[text()='Summer 2022']//preceding-sibling::td//div/input")
	private WebElement summ22chkbox;
	
	@FindBy(xpath="//a[text()='Summer 2022']")
	private WebElement sum2022;
	
	@FindBy(xpath="//table[contains(@data-csi-automation,'MerchCollectionVersion-Target')]//td[2]")
	private WebElement newproduarrowbtn;	
	
	@FindBy(xpath="//td[text()='New From Product']")
	private WebElement newfromprodu;
	
	@FindBy(xpath="//td[text()='New From Style']")
	private WebElement newfromstyle;
	
	@FindBy(xpath="//td[text()='New From Product']")
	private WebElement newfromprod;
	
	@FindBy(xpath="//td[text()='Carryover']")
	private WebElement carryover;
	
	@FindBy(xpath="//td[text()='Carryover with Style']")
	private WebElement carryoverstyle;
	
	@FindBy(xpath="//td[text()='Replenishment']")
	private WebElement replenish;
	
	@FindBy(xpath="//td[text()='Apparel - Color and Size']//preceding-sibling::td//div/input")
	private WebElement appbochekbox;
	
	@FindBy(xpath="//a[text()='Apparel - Color and Size']")
	private WebElement apparelbo;
	
	@FindBy(xpath="(//a[text()='RNT1'])[3]")
	private WebElement merchrntbo;
	
	@FindBy(xpath="(//td[text()='segment1']//following::td[@data-csi-act='PropagateToLevels::0'])[1]")
	private WebElement propagatelvlmon1;
	
	@FindBy(xpath="(//td[text()='segment2']//following::td[@data-csi-act='PropagateToLevels::0'])[1]")
	private WebElement propagatelvlmon2;	
	
	@FindBy(xpath="//label[text()='Collection Version']")
	private WebElement collver;
	
	@FindBy(xpath="//label[text()='Folder Version']")
	private WebElement foldver;
	
	@FindBy(xpath="//label[text()='Option Version']")
	private WebElement optver;
	
	@FindBy(xpath="//label[text()='Product Version']")
	private WebElement prodver;	
	
	@FindBy(xpath="//a[text()='Tops2']")
	private WebElement tops2;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchCollectionVersion-MerchProductVersionsTable-CustomViewActions']")
	private WebElement viewbtn;
	
	@FindBy(xpath="(//td[text()='Manage Views'])[1]")
	private WebElement manageview;	
	
	@FindBy(xpath="(//td[text()='Manage Views'])[2]")
	private WebElement manageview2;	
	
	@FindBy(xpath="//span[@title='Copy custom view']//span[text()='content_copy']")
	private WebElement copyview;		
	
	@FindBy(xpath="//tr[@title='Options']//td[2][text()='Options']")
	private WebElement options;
	
	@FindBy(xpath="//option[@value='Node Name:Child:Children:0{Children}']")
	private WebElement optversion;
	
	@FindBy(xpath="//option[@value='Colorway:Child:Children:0{Children}']")
	private WebElement colorway;	
	
	@FindBy(xpath="//span[text()='Add >']")
	private WebElement add;
	
	@FindBy(xpath="//td[text()='Tops-01']")
	private WebElement tops1chkbox;
	
	@FindBy(xpath="//td[text()='Tops-03']")
	private WebElement top3chkbox;
	
	@FindBy(xpath="(//div[@data-csi-automation='field-MerchProductVersion-CopyProductVersionForm-Quantity']//input)[2]")
	private WebElement qtyinput;
	
	@FindBy(xpath="(//div[@data-csi-automation='field-MerchProductVersion-CopyProductVersionForm-Node Name']//input)[2]")
	private WebElement productinpt;
	
	@FindBy(xpath="//div[@data-csi-automation='field-MerchProductVersion-CopyProductVersionForm-MerchProductStyle']//input")
	private WebElement stylechkbox;
	
	@FindBy(xpath="//div[@data-csi-automation='field-MerchProductVersion-CopyProductVersionForm-MerchProductStyleCandidates']//input")
	private WebElement stylecandichkbox;
	
	@FindBy(xpath="//a[text()='Tops2']//parent::div/span/span")
	private WebElement tops2change;
	
	@FindBy(xpath="//label[text()='Secondaries']")
	private WebElement seconlabel;
	
	@FindBy(xpath="//span[@data-csi-tab-name='Products' and text()='Products']")
	private WebElement productab;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchCollectionVersion-Target-CustomViewActions']")
	private WebElement productviews;
	
	@FindBy(xpath="//option[@value='IdPricePoint::0']")
	private WebElement idpricpt;
	
	@FindBy(xpath="//td[text()='Secondaries']")
	private WebElement Secondaryview;
	
	@FindBy(xpath="//option[@value='PlanSecondary:Child:Secondaries:0{Secondaries}']")
	private WebElement secondaryattrb;	
	
	@FindBy(xpath="(//a[text()='Round Neck T-Shirt']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement rntpricept;
	
	@FindBy(xpath="(//a[text()='RNT1']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement rnt1pricept;
	
	@FindBy(xpath="(//a[text()='Tops-01']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement top1pricept;
	
	@FindBy(xpath="(//a[text()='Tops-02-001']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement top21pricept;
	
	@FindBy(xpath="(//a[text()='Tops-02-002']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement top22pricept;
	
	@FindBy(xpath="(//a[text()='Tops-03']//following::td[@data-csi-heading='IdPricePoint::0'])[1]")
	private WebElement top3pricept;	
	
	@FindBy(xpath="(//div[@data-csi-automation='field-Style-Form-ProductType']/div[3]/input)[1]")
	private WebElement styletype;
	
	@FindBy(xpath="(//td[text()='Apparel - Color and Size']//preceding::td//div//input)[9]")
	private WebElement apparelchckboxrepl;
	
	@FindBy(xpath="//a[text()='Tops-03']//following::td/div[text()='Replenishment']")
	private WebElement top3replenish;
	
	@FindBy(xpath="//a[text()='Tops-01']//following::td/div[text()='Carryover']")
	private WebElement top1carryover;
	
	@FindBy(xpath="//a[text()='Tops-01']//following::td/div[text()='Medium']")
	private WebElement top1idpricevalue;
	
	@FindBy(xpath="//a[text()='Tops-03']//following::td/div[text()='Medium']")
	private WebElement top3idpricevalue;
	
	@FindBy(xpath="//table[contains(@data-csi-automation,'plugin-MerchProductVersion-Target')]//div[text()='New Option']")
	private WebElement newoption;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchCollectionVersion-Target-Actions']")
	private WebElement action;
	
	@FindBy(xpath="//td[text()='Push Attributes To Style']")
	private WebElement attribute;
	
	@FindBy(xpath="//a[text()='RNT1']//following::td[@data-csi-act='IdPricePoint::0']")
	private WebElement rnt1idpoint;
	
	@FindBy(xpath="//td[text()='RNT1']")
	private WebElement rntchkbox;
	
	@FindBy(xpath="//div[text()='Select attributes to add to view']//following::div[contains(@class,'dijitArrowButtonContainer')]")
	private WebElement attributedropdown;
	
	@FindBy(xpath="//option[@value='IdGender:Child:Attributes:0']")
	private WebElement genderattr;
	
	@FindBy(xpath="//option[@value='IdPricePoint:Child:Attributes:0']")
	private WebElement pricepointattr;
	
	@FindBy(xpath="//div[@data-csi-heading='Node Type:' and text()='Collection Version']")
	private WebElement productnavig;
	
	@FindBy(xpath="//div[text()='IdGender']//following::td[text()='Boys']")
	private WebElement gendervalue;
	
	@FindBy(xpath="//div[text()='IdPricePoint']//following::td[text()='High']")
	private WebElement pricpointvalue;
	
	@FindBy(xpath="//a[text()='Round Neck T-Shirt']//following::td[text()='High']")
	private WebElement rntppvalue;	
	
	@FindBy(xpath="//td[text()='Round Neck T-Shirt']")
	private WebElement rouneckchek;
	
	@FindBy(xpath="(//a[text()='Round Neck T-Shirt'])[3]")
	private WebElement rounecklink;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchFolderVersion-TargetFolders-CustomViewActions']")
	private WebElement americaview;
	
	@FindBy(xpath="//option[@value='Brand:Child:__Parent__:0']")
	private WebElement brandoption;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchSeason-Target-CustomViewActions']")
	private WebElement planview;
	
	@FindBy(xpath="//option[@value='ApparelSeason:Child:Season:0']")
	private WebElement apparelseasonopt;
	
	@FindBy(xpath="//a[text()='Americas']//following::td[@data-csi-heading='Brand:Child:__Parent__:0']")
	private WebElement americabranddrp;
	
	@FindBy(xpath="//span[@data-csi-automation='plugin-MerchFolder-Versions-CustomViewActions']")
	private WebElement versionview;
	
	public WebElement getVersionview() {
		return versionview;
	}

	public WebElement getAmericabranddrp() {
		return americabranddrp;
	}

	public WebElement getRntchkbox() {
		return rntchkbox;
	}
	
	public WebElement getCarryoverstyle() {
		return carryoverstyle;
	}
	
	public WebElement getApparelseasonopt() {
		return apparelseasonopt;
	}

	public WebElement getPlanview() {
		return planview;
	}

	public void setPlanview(WebElement planview) {
		this.planview = planview;
	}

	public WebElement getBrandoption() {
		return brandoption;
	}

	public WebElement getAmericaview() {
		return americaview;
	}

	public WebElement getRounecklink() {
		return rounecklink;
	}

	public WebElement getRouneckchek() {
		return rouneckchek;
	}

	public WebElement getRntppvalue() {
		return rntppvalue;
	}
	...
	public WebElement getPricpointvalue() {
		return pricpointvalue;
	}

	public WebElement getProductnavig() {
		return productnavig;
	}

	public WebElement getGenderattr() {
		return genderattr;
	}

	public WebElement getPricepointattr() {
		return pricepointattr;
	}
	...
	public WebElement getMerchrntbo() {
		return merchrntbo;
	}
	
	public WebElement getRnt1idpoint() {
		return rnt1idpoint;
	}
	...
	public WebElement getTop1idpricevalue() {
		return top1idpricevalue;
	}

	public WebElement getTop3idpricevalue() {
		return top3idpricevalue;
	}

	public WebElement getTop3replenish() {
		return top3replenish;
	}

	public WebElement getTop1carryover() {
		return top1carryover;
	}

	public WebElement getTop3chkbox() {
		return top3chkbox;
	}
	
	public WebElement getApparelchckboxrepl() {
		return apparelchckboxrepl;
	}
	...
	public WebElement getRnt1pricept() {
		return rnt1pricept;
	}
	
	public WebElement getSecondaryview() {
		return Secondaryview;
	}

	public WebElement getSecondaryattrb() {
		return secondaryattrb;
	}
	...
	public WebElement getPlantab2() {
		return plantab2;
	}
	
	public WebElement getRntpricept() {
		return rntpricept;
	}

	public WebElement getTop1pricept() {
		return top1pricept;
	}

	public WebElement getTop21pricept() {
		return top21pricept;
	}

	public WebElement getTop22pricept() {
		return top22pricept;
	}

	public WebElement getTop3pricept() {
		return top3pricept;
	}

	public WebElement getIdpricpt() {
		return idpricpt;
	}

	public WebElement getProductab() {
		return productab;
	}

	public WebElement getManageview2() {
		return manageview2;
	}
	
	public WebElement getSeconlabel() {
		return seconlabel;
	}

	public WebElement getTops2change() {
		return tops2change;
	}
	...
	public WebElement getStylecandichkbox() {
		return stylecandichkbox;
	}
	...
	public WebElement getProductinpt() {
		return productinpt;
	}

	public WebElement getTops1chkbox() {
		return tops1chkbox;
	}
	...
	public WebElement getOptversion() {
		return optversion;
	}

	public WebElement getColorway() {
		return colorway;
	}
	...
	public WebElement getManageview() {
		return manageview;
	}

	public WebElement getProductviews() {
		return productviews;
	}

	public WebElement getNewfromprod() {
		return newfromprod;
	}
	...
	public WebElement getTops2() {
		return tops2;
	}

	public WebElement getPropagatelvlmon1() {
		return propagatelvlmon1;
	}
	
	public WebElement getPropagatelvlmon2() {
		return propagatelvlmon2;
	}
	
	public WebElement getCollver() {
		return collver;
	}
	
	public WebElement getFoldver() {
		return foldver;
	}
	
	public WebElement getOptver() {
		return optver;
	}
	
	public WebElement getProdver() {
		return prodver;
	}
	
	public WebElement getApparelbo() {
		return apparelbo;
	}
	
	public WebElement getAppbochekbox() {
		return appbochekbox;
	}
	...
	public WebElement getNewproduarrowbtn() {
		return newproduarrowbtn;
	}
	
	public WebElement getNewfromprodu() {
		return newfromprodu;
	}
	
	public WebElement getSum2022() {
		return sum2022;
	}
	
	public WebElement getSumm22chkbox() {
		return summ22chkbox;
	}
	public WebElement getCollecversionact() {
		return collecversionact;
	}
