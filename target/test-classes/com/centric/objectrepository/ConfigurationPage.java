...
public class ConfigurationPage extends Commonactions{
	...
	@FindBy(xpath="(//div[@data-csi-act='IsFoodAssortment:Child:Config:0']/input[@tabindex='0'])[1]")
	private WebElement style_FoodAssortment;
...
//*****************************************************************************************************
	...
	@FindBy(xpath="//label[text()='Manual Activity']//parent::div/div/input")
	private WebElement ManualActivitycheckbox;
	
	@FindBy(xpath="//div[contains(@data-csi-automation,'field-ProtoActivity-Form-AutocompleteExpression')]//div[2]/div/input")
	private WebElement AutoCompleteExpTextbox;
	...
	public WebElement getAutoCompleteExpTextbox() {
		return AutoCompleteExpTextbox;
	}
	
	public WebElement getManualActivitycheckbox() {
		return ManualActivitycheckbox;
	}
	...
	@FindBy(xpath="(//td[contains(@data-csi-heading,'Active:Child:SetupSetting')]/div/input)[1]")
	private WebElement foodactivechkbox;
	
	@FindBy(xpath="(//td[text()='Pizza']//following-sibling::td/div/input)[1]")
	private WebElement pizzachkbox;
	
	@FindBy(xpath="(//td[text()='Cat Food']//following-sibling::td/div/input)[1]")
	private WebElement catfoodchkbox;
	
	@FindBy(xpath="(//td[text()='Dog Food']//following-sibling::td/div/input)[1]")
	private WebElement dogfoodchkbox;
	
	@FindBy(xpath="(//td[text()='Fruits and Vegetables']//following-sibling::td/div/input)[1]")
	private WebElement fruandVegchkbox;
	
	@FindBy(xpath="(//td[text()='Fast Food']//following-sibling::td/div/input)[1]")
	private WebElement fastfoodchkbox;
	
	
	
	public WebElement getFruandVegchkbox() {
		return fruandVegchkbox;
	}

	public WebElement getFastfoodchkbox() {
		return fastfoodchkbox;
	}



	@FindBy(xpath="(//td[text()='No Data sheets']//following-sibling::td/div/input)[1]")
	private WebElement nodatachkbox;	

	@FindBy(xpath="(//td[contains(@data-csi-heading,'TDSList:Child:SetupSetting')])[1]")
	...
	@FindBy(xpath="//label[text()='Routing']//parent::div/div/input")
	...
	@FindBy(xpath="(//div[text()='New Food Label Data Sheet Type']//following::td[contains(@data-csi-heading,'Active:Child:SetupSetting')]/div/input)[1]")
	private WebElement foodlabelactivechkbox;
	
	@FindBy(xpath="(//td[text()='Food Additives,  Colours and Flavors']//following-sibling::td//div//input)[1]")
	private WebElement foodacfchkbox;
	
	@FindBy(xpath="(//td[text()='No Data section']//following-sibling::td/div/input)[1]")
	private WebElement nodtsecchkbox;

	@FindBy(xpath="(//td[contains(@data-csi-heading,'DataSheetSections:Child:SetupSettings')])[1]")
	...
	public WebElement getFoodacfchkbox() {
		return foodacfchkbox;
	}

	public WebElement getNodtsecchkbox() {
		return nodtsecchkbox;
	}
	
	public WebElement getPizzachkbox() {
		return pizzachkbox;
	}

	public WebElement getCatfoodchkbox() {
		return catfoodchkbox;
	}

	public WebElement getDogfoodchkbox() {
		return dogfoodchkbox;
	}

	public WebElement getNodatachkbox() {
		return nodatachkbox;
	}
	
	public WebElement getNonechkbox() {
		return nonechkbox;
	}
	...
	public WebElement getFoodingredientchkbox() {
	 ...
	 //Project Type Locators
	    ...
	    @FindBy(xpath="(//div[text()='New Project Type']//following::td[contains(@data-csi-heading,'Active:Child:SetupSetting')]/div/input)[1]")
		...
		public WebElement getStyle_FoodAssortment() {
			return style_FoodAssortment;
		}
		...
		@FindBy(xpath="//span[@data-csi-tab-name='Company']")
		private WebElement CompanyTab;
		
		@FindBy(xpath="//span[@data-csi-tab-name='GTIN Setup']")
		private WebElement GTINSetupTab;
		
		@FindBy(xpath="//td[@data-csi-act='GTINLength::0']")
		private WebElement GTINLength;
		
		@FindBy(xpath="//div[@data-csi-automation='field-ManufacturerCode-Form-Code'][1]//input[@class='dijitReset dijitInputInner']")
		private WebElement ManufacturerCode;
		
		@FindBy(xpath="//table[@data-csi-automation='plugin-CompanyInfo-ManufacturerCodes-ToolbarNewActions']")
		private WebElement NewManufaturerCodeBtn;
		
		@FindBy(xpath="//div[@data-csi-automation='field-ManufacturerCode-Form-Node Name'][1]//input[@class='dijitReset dijitInputInner']")
		private WebElement ManufacturerName;
		
		@FindBy(xpath="(//span[text()='Sales Region Specs'])[1]")
		private WebElement SalesRegionSpecs;

		@FindBy(xpath="//table[@data-csi-automation='plugin-ApparelViews-ProductSalesRegionSpecs-ToolbarNewActions']//div/div[2]")
		private WebElement NewSalesRegionSpecsBtn;

		@FindBy(xpath="//div[@data-csi-automation='field-ProductSalesRegionSpec-Form-Node Name']//div/div/input")
		private WebElement SalesRegionSpecsName;

		public WebElement getCompanyTab() {
			return CompanyTab;
		}
		public WebElement getGTINSetupTab() {
			return GTINSetupTab;
		}
		public WebElement getGTINLength() {
			return GTINLength;
		}
		public WebElement getNewManufaturerCodeBtn() {
			return NewManufaturerCodeBtn;
		}
		public WebElement getManufacturerCode() {
		...
		public WebElement getNewSalesRegionSpecs() {
		return NewSalesRegionSpecsBtn;
		}

		public WebElement getSalesRegionSpecsName() {
		return SalesRegionSpecsName;
		}
