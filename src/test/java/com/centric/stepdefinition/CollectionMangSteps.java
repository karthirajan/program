...
public class CollectionMangSteps extends Commonactions {
	...
	InspectionPageSteps ip = new InspectionPageSteps();
	...
	public void performing_delete_action() throws Throwable {
	...
	public void user_creates_style_marketing_products(String string, String string2, String string3) throws Throwable {
		...
		try{
			driver.findElement(By.xpath("(//td[contains(text(),'Automation')]//preceding-sibling::td)//input")).click();
		}
		catch(Exception e)
		{
	...
	public void user_creates_marketing_material_and_looks(String string, String string2) throws Throwable {
		...
		{
			ca.eleToBeClickable();
			ca.click(driver.findElement(By.xpath("(//td[@data-csi-act='State::0'])["+i+"]")));
			...
			{
				try{
					Commonactions.isElementPresent(cm.getColorsizecheckbox());
					ca.click(cm.getColorsizecheckbox());
				}
				catch(Exception e)
				{
					Commonactions.isElementPresent(driver.findElement(By.xpath("(//td[contains(text(),'Collection')]//preceding-sibling::td)//input")));
					driver.findElement(By.xpath("(//td[contains(text(),'Collection')]//preceding-sibling::td)//input")).click();
				}
				Commonactions.isElementPresent(mp.getSave_btn1());
				ca.click(mp.getSave_btn1());
				ca.eleToBeClickable();
			...
			{
				Commonactions.isElementPresent(cm.getMPcheckbox());
	...
	public void user_creates_sales_market_in_collection_management() throws Throwable {
		...
		try{
			for (int i = 0; i < 50; i++) {
				//Commonactions.isElementPresent(minus);
				ip.slider("//div[contains(@class,'Sales')]//span[text()='+']/parent::div");
	...
	public void creates_sales_order(String string, String string2) throws Throwable {
	...
	public void verify_material_SKU_values() throws Throwable {
		...
		String value = driver.findElement(By.xpath("(//td[@data-csi-act='WholesalePrice:Child:MCProductSKUs:0{MCProductSKUs}'])[1]")).getText();
	...
	public void user_creates_marketing_material_and_update_values_in_marketing_product(String string, String string2, String string3) throws Throwable {
		...
		WebElement a = ca.activeElement();
		ca.eleToBeClickable();
		a.sendKeys(string2 +Keys.ENTER);
		ca.eleToBeClickable();
		

		ip.click("//span[@data-csi-act='CMReleaseToMarkets']");
		ca.eleToBeClickable();
		ip.click("//span[@data-csi-act='CMReleaseToCustomers']");
		ca.eleToBeClickable();
		try{
			Commonactions.isElementPresent(pp.getOK_Btn());
			ca.click(pp.getOK_Btn());
	...
	public void user_creates_SKU_sales_market_in_collection_management(String string) throws Throwable {
		...
		try{
			...
			for (int i = 0; i < 100; i++) {
				//Commonactions.isElementPresent(minus);
				ip.slider("(//div[contains(@class,'Sales')]//span[text()='+']/parent::div)[1]");
				if(cm.getSelectstate().isDisplayed()){
					Thread.sleep(1000);
					ip.slider("(//div[contains(@class,'Sales')]//span[text()='+']/parent::div)[1]");
					ip.slider("(//div[contains(@class,'Sales')]//span[text()='+']/parent::div)[1]");
	...
	public void user_creates_sales_order_group_and_update_catalog_configuration() throws Throwable {
		...
		ca.insertText(cm.getSmvalue(), "US");
		ca.jsMouseOver();
		ca.eleToBeClickable();
		Commonactions.isElementPresent(cm.getSmcustomer());
