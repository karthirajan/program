...
Locators lct = new Locators();
	...
	public void validateThOptionsLikeCopyDelete(String a, String colorName) throws Throwable {
		...
		delete.click();
		Thread.sleep(2000);
		Commonactions.isElementPresent(lct.getColorspecDelete());
		ca.click(lct.getColorspecDelete());
	...
	public void mergeTheColorSpecificationAndValidateTheStatusAfterMerging(String a) throws Throwable {
		...
		optionCount.size();
		//   ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getReplacecolorspec());
		ca.click(lct.getReplacecolorspec());
		ca.eleToBeClickable();
