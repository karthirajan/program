...
public class WizardPageSteps extends Commonactions {
	...
	public void navigate_to_new_from_style()throws Throwable {
		...
		ca.eleToBeClickable();
		Commonactions.clickjs(lct.getSelectIndex());	
		ca.click(lct.getW8());
		ca.eleToBeClickable();		
		...
		Commonactions.isElementPresent(lct.getWinter());
	...
	public void create_Move_Style_from_within_the_style_tab()throws Throwable {
		...
		{ 
			...
			Commonactions.isElementPresent(lct.getWizard());
			ca.click(lct.getWizard());
			ca.eleToBeClickable();
	...
	public void navigate_to_apparel_color_and_size_style_add_image()throws Throwable {
		...
		ca.eleToBeClickable();	
		Commonactions.isElementPresent(lct.getStyleType());
		ca.click(lct.getStyleType());
		ca.eleToBeClickable();
		...
		Thread.sleep(1000);
		boolean verify1=Commonactions.isElementPresent(lct.getW1());
		if (verify1==true) {
			Commonactions.isElementPresent(lct.getW2());
			Commonactions.isElementPresent(lct.getW3());
			ca.click(lct.getW4());
			Commonactions.isElementPresent(qp.getNext());
			ca.click(qp.getNext());
			...
			ca.eleToBeClickable();		
			Commonactions.isElementPresent(lct.getW5());
			ca.click(lct.getW5());
			ca.eleToBeClickable();
			WebElement a3 = ca.activeElement();
			ca.eleToBeClickable();
			...
			Commonactions.isElementPresent(qp.getFinish());
			ca.click(qp.getFinish());//parallel
			ca.eleToBeClickable();
		}
		Commonactions.isElementPresent(wp.getFind_item_style());
		ca.click(wp.getFind_item_style());
		ca.eleToBeClickable();
		ca.eleToBeClickable();
		...
		boolean verify2=Commonactions.isElementPresent(lct.getW9());
		if(verify2==true) {
			Commonactions.isElementPresent(wp.getColorway_dropdown());
			wp.getColorway_dropdown().click();
			Commonactions.isElementPresent(lct.getW10());
			ca.click(lct.getW10());
			Commonactions.isElementPresent(lct.getW11());
			ca.click(lct.getW11());
			wp.getColorway_dropdown().click();
	...
	public void navigate_to_new_apparel_wizard_colorway_verify_data_visible()throws Throwable  {
		...
		Commonactions.isElementPresent(lct.getW6());
		Commonactions.isElementPresent(lct.getW7());
		ca.eleToBeClickable();
