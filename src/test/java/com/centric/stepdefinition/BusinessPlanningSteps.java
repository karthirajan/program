...
public class BusinessPlanningSteps extends Commonactions {
	...
	public void user_creates_Business_Plan_for_Style(String BPstyle, String stylecategory, String curreny, String supplier, String season, String brand, String dept, String collection) throws Throwable {
		...
		Commonactions.isElementPresent(lct.getBPAutomation());
		ca.click(lct.getBPAutomation());
	...
	public void verify_the_datas_in_marketplan() throws Throwable {
		...
		if(size>=4)
		{
			System.out.println("All values reflected in Market plan");
		}
		else
		{
			System.out.println("All  values not reflected in Market plan");
		}
		...
		Commonactions.isElementPresent(bp.getProductplanexpand());
		ca.click(bp.getProductplanexpand());
		Commonactions.isElementPresent(bp.getNewformsku());
		ca.click(bp.getNewformsku());
	...
	public void user_select_Style_from_Business_Object(String string) throws Throwable {
		...
		ca.eleToBeClickable();
			...
			ca.eleToBeClickable();
			ca.click(lct.getBusinessobjectfilter());
			WebElement a2 = ca.activeElement();
			ca.eleToBeClickable();
			a2.sendKeys(string);
			ca.eleToBeClickable();
	...
	@Then("user validating Business category custom view")
	public void user_validating_Business_category_custom_view() throws Throwable {
		
		Commonactions.isElementPresent(bp.getHome_icon());
		ca.click(bp.getHome_icon());
		Commonactions.isElementPresent(bp.getBCViews());
		ca.click(bp.getBCViews());
		Commonactions.isElementPresent(bp.getBCManViews());
		ca.click(bp.getBCManViews());
		...
		ca.insertText(up.getUsrMgmt_Copy_Value(), "BC-Custom View");
		Commonactions.isElementPresent(bp.getPrdFilters());
		ca.click(bp.getPrdFilters());
	...
	@Then("user verify custom view actions")
	public void user_verify_custom_view_actions() throws Throwable {
		...
		Commonactions.isElementPresent(bp.getMPViews());
		ca.click(bp.getMPViews());
		Commonactions.isElementPresent(bp.getMpManageViews());
		ca.click(bp.getMpManageViews());
		Commonactions.isElementPresent(up.getUsrMgmt_Copy());
		ca.click(up.getUsrMgmt_Copy());
		Commonactions.isElementPresent(up.getUsrMgmt_Copy_Value());
		ca.insertText(up.getUsrMgmt_Copy_Value(), "MP-Custom View");
		Commonactions.isElementPresent(bp.getVol_Commited());
		ca.click(bp.getVol_Commited());
		Commonactions.isElementPresent(mp.getRemove());
		ca.click(mp.getRemove());
		Commonactions.isElementPresent(bp.getMar_Commited());
		ca.click(bp.getMar_Commited());
		Commonactions.isElementPresent(mp.getRemove());
		ca.click(mp.getRemove());
		Commonactions.isElementPresent(bp.getVol_Forecast());
		ca.click(bp.getVol_Forecast());
		Commonactions.isElementPresent(mp.getRemove());
		ca.click(mp.getRemove());
		Commonactions.isElementPresent(bp.getMar_Forecast());
		ca.click(bp.getMar_Forecast());
		Commonactions.isElementPresent(mp.getRemove());
		ca.click(mp.getRemove());
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
	...
	@Then("user validating volume and margin datas are editable")
	public void user_validating_volume_and_margin_datas_are_editable() throws Throwable {
	    
		Commonactions.isElementPresent(bp.getMP_margin());
		ca.click(bp.getMP_margin());
		ca.eleToBeClickable();
		WebElement a = ca.activeElement();
		ca.eleToBeClickable();
		a.sendKeys(Keys.DELETE);
		ca.eleToBeClickable();
		a.sendKeys("75",Keys.TAB);
		ca.eleToBeClickable();
		WebElement a1 = ca.activeElement();
		ca.eleToBeClickable();
		a1.sendKeys(Keys.DELETE);
	...
	@Then("User Verifying copy, edit and delete action")
	public void user_Verifying_copy_edit_and_delete_action() throws Throwable {
	    
		Commonactions.isElementPresent(bp.getHome_icon());
		ca.click(bp.getHome_icon());
		Commonactions.isElementPresent(bp.getBp_materialCopy());
		ca.click(bp.getBp_materialCopy());
		Commonactions.isElementPresent(bp.getBp_copyValue());
		ca.insertText(bp.getBp_copyValue(),"Plan for material - Copy");
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bp.getBp_materialEdit());
		ca.click(bp.getBp_materialEdit());
		Commonactions.isElementPresent(bp.getBPValue());
		ca.insertText(bp.getBPValue(),"Plan for material - Edited");
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bp.getBp_materialDelete());
		ca.click(bp.getBp_materialDelete());
		Commonactions.isElementPresent(pp.getDelete_Btn());
		ca.click(pp.getDelete_Btn());
		ca.eleToBeClickable();
	...
	@Then("User verify business plan for season  {string}")
	public void user_verify_business_plan_for_season(String copy)throws Throwable {
		String[]CP = copy.split(",");
		Commonactions.isElementPresent(hp.getUser_homeBtn());
		ca.click(hp.getUser_homeBtn());
		...
		Commonactions.isElementPresent(bp.getBusinessplanning());
		ca.click(bp.getBusinessplanning());
		Commonactions.isElementPresent(bp.getBusinessplans());
		System.out.println("Businessplan tab is Displayed");
		Commonactions.isElementPresent(bp.getMarketProductPlans());
		System.out.println("Marketproductplan tab is Displayed");
		Commonactions.isElementPresent(bp.getProductPlans());
		System.out.println("productplan tab is Displayed");
		
		ca.click(bp.getPlanforstyle());
		ca.eleToBeClickable();
		List<WebElement> name = driver.findElements(By.xpath("//button[contains(@class,'MuiButtonBase')]"));
		System.out.println(name.size());
		for (WebElement x : name) {
			System.out.println("the element displayed "+x.getText());
			
		}
		Commonactions.isElementPresent(bp.getPlan());
		ca.click(bp.getPlan());
		System.out.println("plan value displayed correctly");
		Commonactions.isElementPresent(bp.getProductPlans());
		ca.click(bp.getProductPlans());
		/*List<WebElement> n = driver.findElements(By.xpath("//td[contains(@class,'attrString iconEditable firstColumn csi-table-frozen-end')]/a"));
		System.out.println(n.size());
		for (WebElement x : n) {
			System.out.println("the element displayed "+x.getText());
		}*/
		Commonactions.isElementPresent(bp.getMarketProductPlans());
		ca.click(bp.getMarketProductPlans());
		Commonactions.isElementPresent(bp.getDefaultbtn());
		ca.click(bp.getDefaultbtn());
		ca.eleToBeClickable();
		WebElement b1 = ca.activeElement();
		ca.eleToBeClickable();
		b1.sendKeys(Keys.DELETE);
		ca.insertText(b1,CP[0]);
		ca.eleToBeClickable();
		b1.sendKeys(Keys.ENTER);
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bp.getCurrentexchangerates());
		ca.click(bp.getCurrentexchangerates());
		System.out.println("dollar present");
		System.out.println("season verified sucessfully");
	}
		@Then("User verify business plan for brand")
		public void user_verify_business_plan_for_brand()throws Throwable {
		...
		Commonactions.isElementPresent(bp.getDenimbtn());
		ca.click(bp.getDenimbtn());
		Commonactions.isElementPresent(bp.getBusinessplanning());
		ca.click(bp.getBusinessplanning());
		...
		Commonactions.isElementPresent(bp.getProductPlans());
		ca.click(bp.getProductPlans());
		/*List<WebElement> nam1 = driver.findElements(By.xpath("//td[contains(@class,'attrString iconEditable firstColumn csi-table-frozen-end')]/a"));
		System.out.println(nam1.size());
		for (WebElement m1 : nam1) {
			System.out.println("the element displayed "+m1.getText());
		}*/
		Commonactions.isElementPresent(bp.getMarketProductPlans());
		ca.click(bp.getMarketProductPlans());
		Commonactions.isElementPresent(bp.getDefaultbtn());
		...
		ca.insertText(c1,"Copy of Default");
		ca.eleToBeClickable();
		...
		ca.click(bp.getCurrentexchangerates());
		System.out.println("dollar present");
		System.out.println("brand verified sucessfully");
	}
	@Then("User verify business plan for collection{string}")
	public void user_verify_business_plan_for_collection(String copy1)throws Throwable {

		String[]CP1 = copy1.split(",");
		Commonactions.isElementPresent(bp.getHomebtn());
		ca.click(bp.getHomebtn());
		Commonactions.isElementPresent(bp.getWinterseasonbtn());
		ca.click(bp.getWinterseasonbtn());
		...
		Commonactions.isElementPresent(bp.getProductPlans());
		ca.click(bp.getProductPlans());
		/*List<WebElement> name = driver.findElements(By.xpath("//td[contains(@class,'attrString iconEditable firstColumn csi-table-frozen-end')]/a"));
		System.out.println(name.size());
		for (WebElement x : name) {
			System.out.println("the element displayed "+x.getText());
		}*/
		...
		ca.insertText(b2,CP1[0]);
		ca.eleToBeClickable();
		b2.sendKeys(Keys.ENTER);
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bp.getCurrentexchangerates());
		ca.click(bp.getCurrentexchangerates());
		WebElement exc = driver.findElement(By.xpath("//td[text()='Dollar']"));
		System.out.println(exc.getText());
		System.out.println("collection verified sucessfully");
		
		
			
	}
	@Then("User verify business plan for department{string}")
	public void user_verify_business_plan_for_department(String copy2) throws Throwable {

	
	String[]CP2 = copy2.split(",");
		Commonactions.isElementPresent(bp.getHomebtn());
		ca.click(bp.getHomebtn());
		Commonactions.isElementPresent(bp.getWinterseasonbtn());
		ca.click(bp.getWinterseasonbtn());
		...
		Commonactions.isElementPresent(bp.getPlan());
		ca.click(bp.getPlan());
		System.out.println("plan datas present");
		Commonactions.isElementPresent(bp.getProductPlans());
		ca.click(bp.getProductPlans());
		/*List<WebElement> name = driver.findElements(By.xpath("//td[contains(@class,'attrString iconEditable firstColumn csi-table-frozen-end')]/a"));
		System.out.println(name.size());
		...
		ca.insertText(b3,CP2[0]);
		ca.eleToBeClickable();
		b3.sendKeys(Keys.ENTER);
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bp.getCurrentexchangerates());
		ca.click(bp.getCurrentexchangerates());
		...
		WebElement exc = driver.findElement(By.xpath("//td[text()='Dollar']"));
		System.out.println(exc.getText());
		System.out.println("department verified sucessfully");
