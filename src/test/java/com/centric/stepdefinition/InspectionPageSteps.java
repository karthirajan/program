...
public class InspectionPageSteps  extends Commonactions {
	...
	BOMCreationSteps bs = new BOMCreationSteps();
	...
	public void user_creates_TemplateName_BomName_sizechart_and_Dimension(String TemplateName, String BOMName, String SizeChart, String DimensioName,String TestSpecification, String Samplingvalue,String ErrorType,String InspectionGrpName) throws Throwable {
		...
		for(int i=1;i<=size;i++)
		{
			...
			ca.click(mp.getSave_btn1());
			ca.eleToBeClickable();
			ca.click(lct.getAutoinspection());
			ca.eleToBeClickable();
		...
		lct.getDatasetup().click();
		ca.eleToBeClickable();
		lct.getProductqualitysetup().click();
		ca.eleToBeClickable();
	...
	public void User_creates_Style_for_inspection(String BomNam) throws Throwable {
		...
		sm.getColorways().click();
		
		Commonactions.isElementPresent(si.getColorwayViews2());
		si.getColorwayViews2().click();
		
		Commonactions.isElementPresent(si.getColowaymange());
		si.getColowaymange().click();
		...
		for (int i=0;i<120;i++) {
			ca.click(lct.getRight_slider());
		}
		Commonactions.isElementPresent(si.getAntiqchkbox());
		si.getAntiqchkbox().click();
		Commonactions.isElementPresent(si.getVanillachkbox());
		si.getVanillachkbox().click();
		...
		try{
			ca.eleToBeClickable();
			lct.getApparel_BOMsubtype().sendKeys("Apparel BOM");
			ca.eleToBeClickable();
		}catch (Exception e) {
		...
		try {
			ca.eleToBeClickable();
			lct.getMaterial().click();
			lct.getMaterial1().click();
		}
		catch(Exception e)
		{
			try {
		...
		catch(Exception e) {lct.getPlacementshoulder().click();}
		ca.eleToBeClickable();
		WebElement e8 = ca.activeElement();
		ca.eleToBeClickable();
		...
		//{
		//	bs.slider();
		//	boolean disp = driver.findElement(By.xpath("(//span[text()='Common Size'])[3]")).isDisplayed();
		...
		//Commonactions.isElementPresent(si.getNeckcommonclrdrp());
		//ca.click(si.getNeckcommonclrdrp());
		//ca.eleToBeClickable();
		//WebElement en = ca.activeElement();
		//ca.eleToBeClickable();
		//en.sendKeys("11-0104 VANILLA ICE");
		//ca.eleToBeClickable();
		//ca.jsMouseOver();
		//ca.eleToBeClickable();
		
		//Commonactions.isElementPresent(si.getShouldcommonclrdrp());
		//ca.click(si.getShouldcommonclrdrp());
		//ca.eleToBeClickable();
		//WebElement e1 = ca.activeElement();
		//ca.eleToBeClickable();
		//e1.sendKeys("Red");
...
//		Commonactions.isElementPresent(si.getShouldcommonsize());
//		ca.click(si.getShouldcommonsize());
//		ca.eleToBeClickable();
//		WebElement e2 = ca.activeElement();
//		ca.eleToBeClickable();
//		e2.sendKeys("small");
...
//		ca.eleToBeClickable();
		...
		{
			bs.slider();		
			boolean disp = driver.findElement(By.xpath("(//span[text()='Inspection Relevant'])[2]")).isDisplayed();
			System.out.println(disp);
			if(disp==true) {				
				break;
			}
		...
		Commonactions.isElementPresent(si.getInpbomchkbox());
		ca.click(si.getInpbomchkbox());
		ca.eleToBeClickable();
	...
	public void User_creates_ImageDatasheet(String ImageName, String Description) throws Throwable {
		...
		for(int i=0;i<150;i++)
		{
			slider("(//div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div)");
		}

		Commonactions.isElementPresent(si.getInschkbox());
		ca.click(si.getInschkbox());
	...
	public void User_creates_Review(String ReviewName,String ReviewDesc,String canvasNote) throws Throwable {
		...
		for(int i=0;i<150;i++)
		{
			slider("(//span[@data-csi-automation='plugin-Style-StyleReviews-tableSuspend']//following::div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div)");
		}
	...
	public void User_creates_sizechart(String InsSize) throws Throwable {
		...
		for(int i=0;i<150;i++)
		{
			slider("//div[text()='Size Charts']//following::div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div");
		}
		...
		{
			ca.click(lct.getFinalInspectionRelevant1());
			ca.click(lct.getFinalInspectionRelevant2());
			ca.click(lct.getFinalInspectionRelevant3());
		}
	...
	public void User_Copy_BOM_Name(String Bomcopy1, String Bomcopy2) throws Throwable {
		...
		for(int i=0;i<120;i++)
		{
			slider("(//span[text()='Style BOM']//following::div[contains(@class,'dijitSliderIncrementIconH')]//span[text()='+']/parent::div)");
		}
	...
	public void create_NewInspectionSecurityGroup(String ErrorTypes, String AccLimits, String SampleQtyMethods, String InsBatchName, String Attributes, String Batchcolorway, String BatchSize, String Defectvalue, String DefectCounter) throws Throwable 
	{
		...
		{System.out.println("Deviation value is not n double format");		}
	...
	public void slider(String webele)
	{
		List<WebElement> sl = driver.findElements(By.xpath(webele));

		for(int i=1;i<=sl.size();i++)
		{
			WebElement sldr = driver.findElement(By.xpath(webele+"["+i+"]"));
	...
	public void click(String webele) throws Throwable
	{
	List<WebElement> num1 = driver.findElements(By.xpath(webele));
	for(int j=1;j<=num1.size();j++)
	{
		WebElement button = driver.findElement(By.xpath(webele+"["+j+"]"));
	...
	public void passvalue(String webele,String value) throws Throwable
	{
	List<WebElement> num1 = driver.findElements(By.xpath(webele));
	for(int j=1;j<=num1.size();j++)
	{
