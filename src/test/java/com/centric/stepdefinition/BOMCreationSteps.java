...
public class BOMCreationSteps extends Commonactions {
	...
	public void user_creates_NewBOMSection(String Bomsections, String sortvalues, String Materialname) throws Throwable {
		...
		ca.click(lct.getPlacement_product_type());
		...
		ca.jsMouseOver();
		ca.eleToBeClickable();
		ca.click(lct.getPlacement_product_type1());
		ca.eleToBeClickable();
		...
		ca.eleToBeClickable();
		ca.click(lct.getPlacement_product_types());
		ca.click(bc.getFabricstandalone());
		ca.eleToBeClickable();
		ca.click(bc.getSlider1());
		ca.click(lct.getApparelsecplacement_product_types());
		ca.eleToBeClickable();
		ca.click(bc.getAccOnlyColor());
		ca.click(bc.getAppColorandSize());
		ca.eleToBeClickable();
		...
		ca.eleToBeClickable();
		//need to verify the flow -- Inspection issue
		try{
			...
			System.err.println("Issue exist");
			e.printStackTrace();
		}
	...
	public void user_created_NewBOMTemplate(String Subtype, String TemplateName, String createsections, String EditComment) throws Throwable {
		...
		Commonactions.isElementPresent(hp.getSetupSearch());
		ca.insertText(hp.getSetupSearch(), "BOM Templates" +Keys.ENTER);
		ca.eleToBeClickable();
		ca.eleToBeClickable();
		...
		Commonactions.isElementPresent(bc.getCommentBOM());//parallel
		try{
		...
		List<WebElement> ss = driver.findElements(By.xpath("//span[contains(text(),'All section')]//following::tr[1]//td[@role='button']"));
		int s1 = ss.size();
		for (int i = 1; i <= s1; i++) {
			boolean display = driver.findElement(By.xpath("(//span[contains(text(),'All section')]//following::tr[1]//td[@role='button'])["+ i + "]")).isDisplayed();
			ca.eleToBeClickable();
			if (display == true) {
				ca.click(driver.findElement(By.xpath("(//span[contains(text(),'All section')]//following::tr[1]//td[@role='button'])["+ i + "]")));
				ca.eleToBeClickable();
				display = false;
			}
		}
	...
	Thread.sleep(3000);*/
		...
		try{
			...
			ca.click(lct.getCommoncolor());
			ca.eleToBeClickable();
			WebElement b1 = ca.activeElement();

			ca.eleToBeClickable();
			ca.insertText(b1, "VANILLA");
			ca.eleToBeClickable();
			ca.jsMouseOver();
			ca.eleToBeClickable();
		}
		...
		try{
			for (int i = 0; i <= 30; i++) {
				...
				if (lct.getEGRETcolor().isDisplayed()) {		 
					ca.click(bc.getSlider3());
					ca.click(bc.getSlider3());
					break;}
	...
	public void user_verfies_copy_color_for_Material_section() throws Throwable {
		...
		ca.eleToBeClickable();
		ca.click(lct.getOption());
		ca.eleToBeClickable();
		ca.click(lct.getFromcolor());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(mp.getSave_btn1());
		ca.click(mp.getSave_btn1());
		ca.eleToBeClickable();
		...
		/*List<WebElement> findElements = driver.findElements(By.xpath("//td[contains(@data-csi-act,'PMCColor:Child:PartMaterialColors:0{PartMaterialColors}')]//a"));
		for (WebElement webElement : findElements) {
			String name = ca.getText(webElement);
	...
	public void user_update_unit_cost(String string) throws Throwable {
		...
		List<WebElement> bq = driver.findElements(By.xpath("(//span[text()='Neck - placement']/parent::td//following-sibling::td[contains(@data-csi-heading,'BOMLineQuote::0')])"));
		int i = bq.size();
		ca.click(driver.findElement(By.xpath("(//span[text()='Neck - placement']/parent::td//following-sibling::td[contains(@data-csi-heading,'BOMLineQuote::0')])["+i+"]")));
		ca.eleToBeClickable();
		ca.eleToBeClickable();
		WebElement a2 = ca.activeElement();
		ca.eleToBeClickable();
		...
		//	List<WebElement> uc = driver.findElements(By.xpath("(//span[text()='Neck - placement']/parent::td//following-sibling::td[contains(@data-csi-heading,'UnitPriceAct::0')])"));
		//	int j = uc.size();
		//	ca.click(driver.findElement(By.xpath("(//span[text()='Neck - placement']/parent::td//following-sibling::td[contains(@data-csi-heading,'UnitPriceAct::0')])["+j+"]")));
		try{
			ca.eleToBeClickable();
	...
	public void update_unitcost_for_all_in_apparel_section() throws Throwable {
	...
	public void user_edit_color_by_selecting_placements_and_colorways() throws Throwable {
		...
		ca.click(lct.getShoulder());
		ca.eleToBeClickable();
		ca.click(lct.getPlacements());
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bc.getColorways());
		ca.click(bc.getColorways());
		ca.click(lct.getAntique());
		ca.eleToBeClickable();
		ca.click(lct.getPlacements());
		ca.eleToBeClickable();
	...
	public void user_Freezes_the_ApparelBOMValidation_Copy_and_verify_Action_button_is_disabled() throws Throwable {
		...
		{	ca.eleToBeClickable();
		Commonactions.isElementPresent(lct.getBOMvalidationcopy());
		ca.click(lct.getBOMvalidationcopy());
			}
		ca.eleToBeClickable();
		Commonactions.isElementPresent(bc.getApproveAction());
		ca.click(bc.getApproveAction());
	...
	public void user_created_NewFromStyle_in_Apparelsection() throws Throwable {
		...
		try
		{
			List<WebElement> draft = driver.findElements(By.xpath("//span[text()='DRAFT']"));
			for (WebElement webElement : draft) {
		...
		{
			System.out.println("Placement is under pending stage");
		}
	...
	public void user_verify_the_values_refelected_in_multi_level_placements() throws Throwable {
	...
	public void commonosize() throws Throwable
	{
	...
	public void approveaction() throws Throwable
	{
