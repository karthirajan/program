...
public class SizeChartPage extends Commonactions {
	...
	public void userNavigatesToIncrementTabAndCreateCustomView(String arg0) throws Throwable {
		...
		ca.eleToBeClickable();
		Thread.sleep(1000);
		Commonactions.isElementPresent(lct.getPluginAdmin());
		ca.click(lct.getPluginAdmin());
		Commonactions.isElementPresent(lct.getTrPluginAdmin());
		ca.click(lct.getTrPluginAdmin());
