...
//parallel
	...
	@FindBy(xpath="//span[contains(@data-csi-automation,'plugin-Style-ProductColors-CustomViewActions')]//span[text()='Views']")
	private WebElement colorwayViews2;
	...
	@FindBy(xpath="//tr[contains(@data-csi-automation,'plugin-Style-ProductColors-CustomViewManage')]//td[text()='Manage Views']")
	private WebElement colowaymange;

	@FindBy(xpath="(//a[text()='11-0104 VANILLA ICE']//following::div[@data-csi-act='FinalInspectionRelevant::0']//input)[1]")
	private WebElement vanillachkbox;

	@FindBy(xpath="(//a[text()='11-0105 ANTIQUE WHITE']//following::div[@data-csi-act='FinalInspectionRelevant::0']//input)[1]")
	private WebElement antiqchkbox;
	...
	@FindBy(xpath="(//div[contains(@data-csi-act,'EnableMaterialSchedule')]/input)[3]")
	private WebElement Matechckbox;
...
@FindBy(xpath="(//span[text()='Inspection Relevant'])[2]")
	private WebElement inspecrelevchek;

@FindBy(xpath="//a[text()='INS-IDS']//following::div[contains(@data-csi-act,'FinalInspectionRelevant:')]")
private WebElement inschkbox;

@FindBy(xpath="//a[text()='Ins-BOM']//following::div[contains(@data-csi-act,'FinalInspectionRelevant:')]")
private WebElement inpbomchkbox;

@FindBy(xpath="(//span[text()='Neck - placement']/following::td[@data-csi-heading='CommonColor::0'])[5]")
private WebElement neckcommonclrdrp;

@FindBy(xpath="(//span[text()='Shoulder - placement']/following::td[@data-csi-act='CommonColor::0'])[5]")
private WebElement shouldcommonclrdrp;

@FindBy(xpath="(//span[text()='Neck - placement']/following::td[@data-csi-heading='CommonSize::0'])[5]")
private WebElement shouldcommonsize;

public WebElement getNeckcommonclrdrp() {
	return neckcommonclrdrp;
}

public WebElement getShouldcommonclrdrp() {
	return shouldcommonclrdrp;
}

public WebElement getShouldcommonsize() {
	return shouldcommonsize;
}

public WebElement getVanillachkbox() {
	return vanillachkbox;
}

public WebElement getAntiqchkbox() {
	return antiqchkbox;
}

public WebElement getColorwayViews2() {
	return colorwayViews2;
}

public WebElement getColowaymange() {
	return colowaymange;
}

public WebElement getMatechckbox() {
	return Matechckbox;
}
public WebElement getInschkbox() {
	return inschkbox;
}
public WebElement getInpbomchkbox() {
	return inpbomchkbox;
}
public WebElement getInspecrelevchek() {
	return inspecrelevchek;
}
