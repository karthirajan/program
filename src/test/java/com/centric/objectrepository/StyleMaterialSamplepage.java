...
public class StyleMaterialSamplepage extends Commonactions {
	...
	private WebElement StyleIssuesTab;
	
	@FindBy(xpath="//span[contains(@data-csi-automation,'plugin-IssueLog-Issues-CustomViewActions')]//span[@title='Manage custom views']")
	private WebElement IssuesPropView;
	
	@FindBy(xpath="//tr[contains(@data-csi-automation,'plugin-IssueLog-Issues-CustomViewManage')]//td[text()='Manage Views']")
	private WebElement IssuesPropViewManage;
	
	@FindBy(xpath="(//table[contains(@data-csi-automation,'plugin-IssueLog-Issues-ToolbarNewActions')]//div/div)[2]")
	private WebElement NewStyleIssues;
	
	@FindBy(xpath="//div[@data-csi-automation='field-Issue-Form-Owner']//div[3]/input[1]")
	private WebElement Owner;
	
	@FindBy(xpath="(//div[contains(@data-csi-automation,'field-Issue-Form-IssueProductSize')]/div)[3]")
	private WebElement IssueSize;
	
	@FindBy(xpath="(//div[contains(@data-csi-automation,'field-Issue-Form-IssueProductColors')]/div)[3]")
	private WebElement IssueColors;
	
	@FindBy(xpath="(//div[contains(@data-csi-automation,'field-Issue-Form-DueDate')]/div[3]/input[1])[1]")
	private WebElement Issuedate;
	
	@FindBy(xpath="(//div[contains(@data-csi-automation,'field-Issue-Form-Node Name')]/div[2]/div/input)[1]")
	private WebElement IssueValue;
	
	public WebElement getStyleIssuesTab() {
		return StyleIssuesTab;
	}
	public WebElement getIssuesPropView() {
		return IssuesPropView;
	}
	public WebElement getIssuesPropViewManage() {
		return IssuesPropViewManage;
	}	
	public WebElement getNewStyleIssues() {
		return NewStyleIssues;
	}
	public WebElement getOwner() {
		return Owner;
	}

	public WebElement getIssueSize() {
		return IssueSize;
	}
	public WebElement getIssueColors() {
		return IssueColors;
	}
	...
	@FindBy(xpath="(//div[contains(@data-csi-automation,'RequestSampleSizeRange')]/div)[1]")
	private WebElement AltSizeRange;
	@FindBy(xpath="(//td[contains(@data-csi-act,'ActualSizeRange:Child:Attributes:0')])[1]")
	private WebElement PropSizeRange;
	
	public WebElement getAltSizeRange() {
		return AltSizeRange;
	}
	public WebElement getPropSizeRange() {
		return PropSizeRange;
	}		
