...
public class StyleandThemePage extends Commonactions{
	...
	@FindBy(xpath="(//div[contains(text(),'Automation')]//parent::td//parent::tr//div/input)[1]")
	...
	@FindBy(xpath="(//span[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-Actions']/span)[2]")
	private WebElement ApproveActionsStyle;
	
	@FindBy(xpath="(//tr[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-UnlinkFromTheme']/td[text()='Unlink From Theme'])[2]")
	private WebElement UnlinkFTheme;
	
	@FindBy(xpath="(//tr[@data-csi-automation='plugin-ProductBOMRevision-PartMaterials-SynchBOMFromTheme']/td[text()='Synch BOM From Theme'])[2]")
